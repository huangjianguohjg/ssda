...
//    self.iconView.backgroundColor = [UIColor redColor];
    ...
    self.phoneTextField.textColor = [UIColor colorWithHexValue:0x838383 alpha:1.0];
    [self addSubview:self.phoneTextField];
    [self.phoneTextField makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.iconView.bottom).offset(141);
    ...
    self.authTextField.textColor = [UIColor colorWithHexValue:0x838383 alpha:1.0];
