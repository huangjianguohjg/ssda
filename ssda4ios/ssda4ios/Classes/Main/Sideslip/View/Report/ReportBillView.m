...
{
    //订单相关投诉
    UILabel * billReport = [UILabel lableWithTextColor:[UIColor colorWithHexValue:0x131313 alpha:1.0] textFont:W(14) text:@"订单相关投诉:"];
...
//        make.size.equalTo(CGSizeMake(W(155), H(35)));
    ...
    //请选择举报原因
    UILabel * reasonReport = [UILabel lableWithTextColor:[UIColor colorWithHexValue:0x131313 alpha:1.0] textFont:W(14) text:@"请选择举报原因:"];
