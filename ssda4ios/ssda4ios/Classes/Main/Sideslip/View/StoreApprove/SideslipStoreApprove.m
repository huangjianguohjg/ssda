...
//    
    ...
    [iconLable makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self).offset(H(108));
        make.centerX.equalTo(self);
    }];
    ...
    UIImageView * nameImageViewLine = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"separator"]];
    ...
    updateId.detailLable.font = [UIFont systemFontOfSize:15];
    ...
    updateAddress.detailLable.font = [UIFont systemFontOfSize:15];
