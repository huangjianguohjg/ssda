...
-(void)setUpUI
{
    //nameLable
    //我的名称
    self.nameLable=  [UILabel lableWithTextColor:[UIColor colorWithHexValue:0xFFFFFF alpha:1.0] textFont:W(15) text:@"我的名称"];
...
//        make.size.equalTo(CGSizeMake(W(100), H(30)));
    ...
    //具体名称标签
    self.detailLable=  [UILabel lableWithTextColor:[UIColor colorWithHexValue:0xFFFFFF alpha:1.0] textFont:W(15) text:@"俏西北国际美食中心"];
